...
<div class="col-sm-10">
  ...
  <div>
    ...
    <ul class="nav nav-tabs" role="tablist">
      <li role="presentation" class="active"><a href="#userListPanel" aria-controls="home" role="tab" data-toggle="tab">用户列表</a></li>
      <li role="presentation"><a href="#addUserPanel" aria-controls="profile" role="tab" data-toggle="tab">添加用户</a></li>
    </ul>
    <!-- Tab panes -->
          ...
          <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
              ...
              <ul class="list-unstyled">
                <!-- 添加用户按钮 -->
                <li><button class="btn btn-success btn-sm">添加用户</button></li>
              </ul>
